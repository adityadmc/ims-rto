...
export async function signupHandler(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const authorityToDrive = req.body.authorityToDrive;

        const data = JSON.stringify({
            firstName, lastName, DOB, gender, sonOfOp, sonOfVal, addressLine1, addressLine2, state, pincode, authorityToDrive
        });
